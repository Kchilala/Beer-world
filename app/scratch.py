...
# from app import data_exploration as de
...
def total_beer_production(data: list[dict[str,any]]) -> dict[str, int]:
    """
...
# def alcohol_by_volume(data: list[dict[str,any]]) -> dict[str,float]:
#
#     abv: dict = {}
#
#     =de.get_breweries_from_style(data, 'blonde')
#         de.compute_mean_abv()
#
# print(alcohol_by_volume(read_dataset(path)))
